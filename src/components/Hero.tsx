...
export function Hero() {
  return (
    <section className="relative min-h-[calc(82vh-64px)] overflow-hidden bg-pine-900 text-white">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-pine-900/92 via-pine-900/58 to-water-900/20" />
      <div className="absolute inset-0 bg-gradient-to-t from-pine-900/78 via-transparent to-transparent" />

      <div className="container-page relative flex min-h-[calc(82vh-64px)] items-center py-16">
